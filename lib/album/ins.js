    ...
    function(module, exports, __webpack_require__) {
      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            var minSrc = 'https://raw.githubusercontent.com/lwanting/blog_album/master/photo/min_pic/' + data.link[i];
            var src = 'https://raw.githubusercontent.com/lwanting/blog_album/master/photo/pic/' + data.link[i];
          ...
          //   var minSrc = 'https://raw.githubusercontent.com/lwanting/blog_album/master/min_photos/' + data.link[i];
			
          //  // var src = 'https://raw.githubusercontent.com/yourgithub/Blog_Album/master/photos/' + data.link[i];
          //   var src = 'https://raw.githubusercontent.com/lwanting/blog_album/master/photos/' + data.link[i];
      ...
      function loadData(success) {
        if (!searchData) {
          ...
          xhr.open('GET', '../lib/album/photo.json?t=' + +new Date(), true);
